...
ALL_LEAGUES = {
    # נשים
    637: 'נשים', 639: 'נשים', 741: 'נשים', 654: 'נשים', 
    651: 'נשים', 641: 'נשים', 808: 'נשים', 860: 'נשים',
    823: 'נשים', 809: 'נשים', 859: 'נשים', 705: 'נשים',
    815: 'נשים', 749: 'נשים', 717: 'נשים', 900: 'נשים',
    810: 'נשים', 901: 'נשים', 903: 'נשים', 902: 'נשים',
    
    # נוער
    101: 'נוער', 103: 'נוער', 102: 'נוער', 105: 'נוער',
    104: 'נוער', 920: 'נוער', 787: 'נוער', 666: 'נוער',
    110: 'נוער', 115: 'נוער',
    
    # נערים א'
    726: 'נערים א\'', 121: 'נערים א\'', 120: 'נערים א\'', 
    646: 'נערים א\'', 755: 'נערים א\'', 123: 'נערים א\'',
    122: 'נערים א\'', 665: 'נערים א\'', 664: 'נערים א\'',
    
    # נערים ב'
    773: 'נערים ב\'', 719: 'נערים ב\'', 720: 'נערים ב\'',
    135: 'נערים ב\'', 139: 'נערים ב\'', 706: 'נערים ב\'',
    131: 'נערים ב\'', 137: 'נערים ב\'', 130: 'נערים ב\'',
    658: 'נערים ב\'', 134: 'נערים ב\'',
    
    # נערים ג'
    824: 'נערים ג\'', 845: 'נערים ג\'', 826: 'נערים ג\'',
    736: 'נערים ג\'', 663: 'נערים ג\'', 758: 'נערים ג\'',
    759: 'נערים ג\'', 146: 'נערים ג\'', 816: 'נערים ג\'',
    707: 'נערים ג\'', 144: 'נערים ג\'',
    
    # ילדים א'
    871: 'ילדים א\'', 155: 'ילדים א\'', 734: 'ילדים א\'',
    870: 'ילדים א\'', 648: 'ילדים א\'', 865: 'ילדים א\'',
    764: 'ילדים א\'', 875: 'ילדים א\'', 876: 'ילדים א\'',
    662: 'ילדים א\'', 862: 'ילדים א\'', 152: 'ילדים א\'',
    156: 'ילדים א\'', 788: 'ילדים א\'', 150: 'ילדים א\'',
    712: 'ילדים א\'', 872: 'ילדים א\'', 863: 'ילדים א\'',
    158: 'ילדים א\'', 154: 'ילדים א\'', 861: 'ילדים א\'',
    
    # ילדים ב'
    880: 'ילדים ב\'', 739: 'ילדים ב\'', 748: 'ילדים ב\'',
    689: 'ילדים ב\'', 852: 'ילדים ב\'', 868: 'ילדים ב\'',
    804: 'ילדים ב\'', 881: 'ילדים ב\'', 882: 'ילדים ב\'',
    897: 'ילדים ב\'', 161: 'ילדים ב\'', 165: 'ילדים ב\'',
    792: 'ילדים ב\'', 879: 'ילדים ב\'', 160: 'ילדים ב\'',
    747: 'ילדים ב\'', 767: 'ילדים ב\'', 878: 'ילדים ב\'',
    167: 'ילדים ב\'', 163: 'ילדים ב\'', 877: 'ילדים ב\'',
    765: 'ילדים ב\'',
    
    # ילדים ג'
    886: 'ילדים ג\'', 887: 'ילדים ג\'', 175: 'ילדים ג\'',
    713: 'ילדים ג\'', 769: 'ילדים ג\'', 890: 'ילדים ג\'',
    888: 'ילדים ג\'', 770: 'ילדים ג\'', 883: 'ילדים ג\'',
    884: 'ילדים ג\'', 794: 'ילדים ג\'', 738: 'ילדים ג\'',
    173: 'ילדים ג\'', 793: 'ילדים ג\'', 744: 'ילדים ג\'',
    170: 'ילדים ג\'', 172: 'ילדים ג\'', 885: 'ילדים ג\'',
    891: 'ילדים ג\'', 174: 'ילדים ג\'', 892: 'ילדים ג\'',
    661: 'ילדים ג\'', 780: 'ילדים ג\'', 750: 'ילדים ג\'',
    649: 'ילדים ג\'',
...
class LeaguesTablesScraper:
    ...
    def scrape_league_table(self, league_id, age_group):
        ...
        try:
            ...
            teams = []
            try:
                table_rows = self.driver.find_elements(By.CSS_SELECTOR, '.table_row.link_url')
                ...
                if teams:
                    ...
                    print(f"⚠️  League {league_id}: {league_name} - אין טבלה")
                    return None
                    
            except Exception as e:
                print(f"❌ League {league_id}: שגיאה בשליפת טבלה - {e}")
                return None
    ...
    def scrape_all_leagues(self):
        ...
        for i, (league_id, age_group) in enumerate(ALL_LEAGUES.items(), 1):
            ...
            if i % 20 == 0:
                print(f"📍 התקדמות: {i}/{len(ALL_LEAGUES)} ליגות")
            
            time.sleep(0.5)  # המתן קצר בין בקשות
