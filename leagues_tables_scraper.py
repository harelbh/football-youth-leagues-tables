...
class LeaguesTablesScraper:
    ...
    def scrape_league_table(self, league_id, age_group):
        ...
        try:
            ...
            teams = []
            try:
                # חפש את הטבלה - יכול להיות table-w-playoff או סתם league-table
                table_rows = self.driver.find_elements(By.CSS_SELECTOR, 'a.table_row[href*="team-details"]')
                
                print(f"   🔍 נמצאו {len(table_rows)} שורות בטבלה")
